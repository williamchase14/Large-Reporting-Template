...
build_slide <- function(
  ...
  # 4) Filter to "2. Diagnostic & Implementation"
  filtered_data <- latest_by_school %>%
    filter(engagement_type == "2. Diagnostic & Implementation" |
             engagement_type == "2. Diagnostic &amp; Implementation")
  ...
  title_txt <- "Diagnostic & Implementation"
